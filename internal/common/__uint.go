...
func _OneUint() Uint { return Uint{big.NewInt(1)} }
...
func (u Uint) MulI(u2 Uint) (res Uint) {
	return NewUintFromBigInt(new(big.Int).Mul(u.i, u2.i))
}
// Mul multiplies two Uints
func (u Uint) Mul(u2 Uint) (res Uint) {
	return NewUintFromBigInt(div(mul(u.i, u2.i), OneUint8.i))
}

// Mul multiplies two Uints
func (u Uint) MulUint64(u2 uint64) (res Uint) { return u.Mul(NewUint(u2)) }

// QuoI divides Uint with Uint
func (u Uint) QuoI(u2 Uint) (res Uint) { return NewUintFromBigInt(div(u.i, u2.i)) }

// Quo divides Uint with Uint with Fixed8 precision
func (u Uint) Quo(u2 Uint) (res Uint) { return NewUintFromBigInt(div(mul(u.i, OneUint8.i), u2.i)) }
...
func (u Uint) _String() string { return u.i.String() }

// Human readable string
func (u Uint) String() string { 
	part1 := div(u.i, OneUint8.i)
	part2 := sub(u.i, mul(part1, OneUint8.i))
	return fmt.Sprintf("%v.%8v", part1.String(), part2.String())
}
