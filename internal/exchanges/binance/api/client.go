...
// NewCoinInfoService init getting account service
func (c *Client) NewCoinInfoService() *CoinInfoService {
	return &CoinInfoService{c: c}
}
...
func (c *Client) NewGetDepositAddressWithNetworkService() *GetDepositsAddressWithNetworkService {
	return &GetDepositsAddressWithNetworkService{c: c}
}
...
// NewAssetDetailService init assetdetail service
