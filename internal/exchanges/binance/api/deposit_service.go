...
// GetDepositsAddressWithNetworkService retrieves the details of a deposit address.
//
// See https://binance-docs.github.io/apidocs/spot/en/#deposit-address-supporting-network-user_data
type GetDepositsAddressWithNetworkService struct {
	c       *Client
	coin  	string
	network	*string
}
// Coin sets the coin parameter (MANDATORY).
func (s *GetDepositsAddressWithNetworkService) Coin(v string) *GetDepositsAddressWithNetworkService {
	s.coin = v
	return s
}

// Network sets the network parameter (MANDATORY).
func (s *GetDepositsAddressWithNetworkService) Network(v string) *GetDepositsAddressWithNetworkService {
	s.network = &v
	return s
}

// Do sends the request.
func (s *GetDepositsAddressWithNetworkService) Do(ctx context.Context) (*GetDepositsAddressWithNetworkResponse, error) {
	r := &request{
		method:   "GET",
	...
	res := &GetDepositsAddressWithNetworkResponse{}
	if err := json.Unmarshal(data, res); err != nil {
		return nil, err
	}
...
// GetDepositsAddressWithNetworkResponse represents a response from GetDepositsAddressWithNetworkService.
type GetDepositsAddressWithNetworkResponse struct {
	Address string `json:"address"`
